  ...
  return (
    <div 
      ...
      style={{ 
        ...
        gridColumn: dragSize?.gridColumn || mergedStyle?.gridColumn || (arrayKey === 'order' ? 'span 12' : undefined),
        gridRow: dragSize?.gridRow || mergedStyle?.gridRow || undefined,
        width: dragSize?.width || mergedStyle?.width || (id?.startsWith('btn_') ? 'fit-content' : '100%'), 
        height: dragSize?.height || mergedStyle?.height || (id?.startsWith('btn_') ? 'auto' : (arrayKey === 'order' ? '100%' : undefined)), 
