...
export default function About() {
  const { t } = useLang();
  const { layout, isBuilder } = useBuilderLayout('about', { order: [], hidden: [], styles: {}, images: {} });

  const blockStyle = layout?.styles?.about_main || {};

  return (
    <div style={{ paddingTop: '150px', minHeight: '100vh', background: 'var(--background)', ...blockStyle }}>
      <BuilderWrapper id="about_main" isBuilder={isBuilder}>
