...
export default function Contacts() {
  const { t } = useLang();
  const { layout, isBuilder } = useBuilderLayout('contacts', { order: [], hidden: [], styles: {}, images: {} });

  const blockStyle = layout.styles?.contacts_main || {};

  return (
    <div style={{ paddingTop: '150px', minHeight: '100vh', background: 'var(--background)', ...blockStyle }}>
      <BuilderWrapper id="contacts_main" isBuilder={isBuilder}>
