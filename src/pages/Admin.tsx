  ...
  return (
    ...
    <div className="admin-layout" style={{ display: 'flex', minHeight: '100vh', background: '#050505', color: '#ffffff', position: 'relative', zIndex: 999999, pointerEvents: 'auto', fontFamily: 'Inter, system-ui, sans-serif' }}>
      ...
      <motion.div animate={{ width: sidebarWidth }} style={{ background: '#0a0a0a', borderRight: '1px solid #222', padding: isSidebarOpen ? '5rem 1.5rem 2rem 1.5rem' : '0', display: 'flex', flexDirection: 'column', gap: '2rem', position: 'fixed', height: '100vh', zIndex: 2500, boxShadow: '10px 0 50px rgba(0,0,0,0.5)', overflow: 'hidden' }}>
        ...
        <Link to="/" style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', color: 'var(--admin-accent)', fontWeight: '800', fontSize: '0.8rem', textDecoration: 'none', background: 'rgba(var(--admin-accent-rgb), 0.05)', padding: '1rem', borderRadius: '8px', border: '1px solid #222' }}>
        ...
        <div style={{ display: 'flex', background: '#1a1a1a', padding: '0.3rem', borderRadius: '8px', border: '1px solid #222' }}>
          ...
          {(['ru', 'kk', 'en'] as const).map((l) => (
            ...
            <button key={l} onClick={() => setLang(l)} style={{ flex: 1, padding: '0.6rem', borderRadius: '6px', border: 'none', background: lang === l ? 'var(--admin-accent)' : 'transparent', color: lang === l ? '#000' : '#888', fontSize: '0.7rem', fontWeight: '900', cursor: 'pointer', transition: '0.2s', textTransform: 'uppercase' }}>{l}</button>
        ...
        <div className="logo" style={{ fontSize: '1.2rem', fontWeight: '900', letterSpacing: '-0.02em' }}>DEMETRA<span style={{ color: 'var(--admin-accent)' }}>SYSTEM</span><div style={{ fontSize: '0.6rem', color: 'var(--admin-accent)', letterSpacing: '0.2em', marginTop: '0.25rem' }}>TILDA_MODE V2.1</div></div>
        ...
        <nav style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
          ...
          {tabs.map(tab => (
            ...
            <button key={tab.id} onClick={() => setActiveTab(tab.id)} style={{ display: 'flex', alignItems: 'center', gap: '1rem', padding: '1rem', borderRadius: '12px', border: 'none', background: activeTab === tab.id ? 'rgba(var(--admin-accent-rgb), 0.1)' : 'transparent', color: activeTab === tab.id ? 'var(--admin-accent)' : '#888', cursor: 'pointer', transition: '0.2s', textAlign: 'left', fontWeight: '700', fontSize: '0.9rem' }}>{tab.icon} {tab.label}</button>
       ...
       <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem' }}>
          ...
          {Object.entries(allTranslations[currentLang]).filter(([k]) => k.includes(search)).map(([k, v]: any) => (
             ...
             <div key={k} style={{ display: 'grid', gap: '0.5rem' }}>
                ...
                <label style={{ fontSize: '0.6rem', color: 'var(--admin-accent)', fontWeight: '900' }}>{k.toUpperCase()}</label>
  ...
  return (
    ...
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '3rem' }}>
      ...
      <div style={{ background: '#0a0a0a', padding: '3rem', borderRadius: '32px', border: '1px solid #222', display: 'flex', flexDirection: 'column', gap: '2rem' }}>
        ...
        <h3 style={{ fontWeight: '900', color: 'var(--admin-accent)', letterSpacing: '0.1em', display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                ...
                {isEditing ? (
                  ...
                  <div style={{ display: 'grid', gap: '1rem' }}>
                    ...
                    <div style={{ display: 'flex', gap: '0.5rem', marginTop: '0.5rem' }}>
                      ...
                      <button onClick={() => handleSaveEdit(p.id)} style={{ background: 'var(--admin-accent)', color: '#000', border: 'none', padding: '0.5rem 1rem', borderRadius: '6px', fontWeight: '800', cursor: 'pointer', fontSize: '0.8rem' }}>Сохранить</button>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <div>
                      ...
                      <div style={{ fontSize: '0.8rem', color: 'var(--admin-accent)', fontWeight: '700', marginTop: '0.25rem' }}>{p.path}</div>
